...
void categorizar (int idade)
{
  if (idade >= 5 && idade <= 7)
  {
    printf ("\nVoce faz parte da categoria de base INFANTIL A!\n\n");
  }
  else if (idade >= 8 && idade <= 10)
  {
    printf ("\nVoce faz parte da categoria de base INFANTIL B!\n\n");
  }
  else if (idade >= 11 && idade <= 13)
  {
    printf ("\nVoce faz parte da categoria de base JUVENIL A!\n\n");
  }
  else if (idade >= 14 && idade <= 17)
  {
    printf ("\nVoce faz parte da categoria de base JUVENIL B!\n\n");
  }
  else if (idade >= 18)
  {
    printf ("\nVoce faz parte da categoria ADULTO!\n\n");
  }
  else
  {
    printf ("\nVoce nao faz parte das categorias de base.\n\n");
  }
}
...
void conceituar (int media)
{
  if (media >= 0 && media < 5)
  {
    printf ("\nSua nota e CONCEITO D!\n\n");
  }
  else if (media >= 5 && media < 7)
  {
    printf ("\nSua nota e CONCEITO C!\n\n");
  }
  else if (media >= 7 && media < 9)
  {
    printf ("\nSua nota e CONCEITO B!\n\n");
  }
  else
  {
    printf ("\nSua nota e CONCEITO A!\n\n");
  }
}
...
void verificar13 (int lado1, int lado2, int lado3)
{
  ...
  {
  printf ("\nERRO! Os valores inseridos nao satisfazem a condicao de existencia de um triangulo.\n\n");
  }
}
