/* FUNÇÕES:
- Média: recebe uma matriz de inteiros e retorna o valor da média dos elementos da matriz (retorno em inteiro);
- Mediana: recebe uma matriz de inteiros e retorna o valor mediano dos elementos dessa matriz (retorno em inteiro);
- Moda: recebe uma matriz de inteiros e retorna a moda dos elementos. Caso a moda seja mais de um elemento, retornar a média dos mesmos;
- Imprimir uma matriz no arquivo.csv;
- Crie uma biblioteca contendo todas essas funções e envie somente ela ao professor. */
